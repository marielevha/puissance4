...
public class PlateauCopy extends Plateau {
    ...
    public synchronized void jouerAB(Player player/*, PanelAffichage panelAffichage*/){
        if(getNbrJeton()>1){
    ...
    public synchronized void jouerMinMax(Player joueur/*, PanelAffichage panelAffichage*/){
        if(getNbrJeton()>1){
            this.nbrNoeuds = 0;
            int max = -10000000;
