...
public class Ovale extends Dessin {
     ...
     * @exception RuntimeException Cette exception est lancée si on tente de construire un ovale avec des dimensions négatives.
	...
	if(largeur<0)
	    throw new RuntimeException("Impossible de créer un ovale de largeur négative : "+largeur);
	if(hauteur<0)
	    throw new RuntimeException("Impossible de créer un ovale de hauteur négative : "+hauteur);
    }
