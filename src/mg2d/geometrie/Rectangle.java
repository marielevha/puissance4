...
public class Rectangle extends Dessin {
     ...
     * @exception RuntimeException Cette exception est lancée si :<ul><li>les arrondis ont des dimensions négatives</li><li>si on tente de construire un rectangle avec des dimensions négatives</li><li>si le coin bas gauche et au dessus ou à droite du coin haut droit.</li></ul>.
	...
	if(a.getX()>b.getX() || a.getY()>b.getY())
	    throw new RuntimeException("Impossible de créer un rectangle dont le coin bas gauche se trouve au dessus ou à droite du coin haut droite. Coin bas gauche : "+a+". Coin haut droit : "+b);
    }
	...
	if(arcLargeur<0)
	    throw new RuntimeException("Impossible de créer un arrondi en largeur de "+arcLargeur);
	if(arcHauteur<0)
	    throw new RuntimeException("Impossible de créer un arrondi en hauteur de "+arcHauteur);
    }
	...
	if(largeur<0)
	    throw new RuntimeException("Impossible de créer un rectangle de largeur négative : "+largeur);
	if(hauteur<0)
	    throw new RuntimeException("Impossible de créer un rectangle de hauteur négative : "+hauteur);
    }
