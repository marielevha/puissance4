...
public class Animation extends Texture {
     ...
     * @exception RuntimeException Ce constructeur ne prenant pas de parmètre ne fait que lancer l'exception.
     * @see <a href="https://docs.oracle.com/javase/7/docs/api/java/lang/RuntimeException.html" target="_blank">RuntimeException</a>
     */
    public Animation(){
	throw new RuntimeException("Le constructeur par défaut d'animation ne peut être appelé. Il faut au moins spécifier une image.");
    }
